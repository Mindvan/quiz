                    ...
                    <div class="bird__audio">
                        <div class="bird__duration">
                            ...
                            <div class="bird__volume">
                                ...
                                <input type="range" class="bird__answer-volume" min="0" max="100" value="75">
...
const listener = (event) => {
    ...
    const volumeRangeAnswer = target.parentElement.nextElementSibling.nextElementSibling.children[1];
    const volumeCountAnswer = target.parentElement.nextElementSibling.nextElementSibling.children[3];
